<template>
  <div class="guides" v-show="show" @click.stop="close">
    <div class="img">
...
<script>
  import { XDialog, TransferDomDirective as TransferDom, Flexbox, FlexboxItem, XButton } from 'vux'
  ...
  export default {
    ...
    components: {
      XDialog, Flexbox, FlexboxItem, XButton
    },
    props: {
      visibile: Boolean,
      upornotCountDown: Number,
      coinPrice: Number,
    },
    computed: {
      show () {
